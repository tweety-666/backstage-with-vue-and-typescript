    ...
    >
      ...
      <el-form-item label="username" prop="username">
        <el-input
          ...
          placeholder="plz enter username"
        ></el-input>
      </el-form-item>
    </el-form>
    <span slot="footer" class="dialog-footer">
      <el-button @click="$emit('closeDialog')">cancel</el-button>
      <el-button @click="handleAdd" type="primary">confirm</el-button>
    </span>
  </el-dialog>
</template>
...
export default class AddAccount extends Vue {
  ...
  @Provide() rules: any = {
    ...
    role: [{ required: true, message: "plz select a role", trigger: "change" }],
  };
